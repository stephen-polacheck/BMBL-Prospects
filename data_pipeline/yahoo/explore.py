...
def get_chosen_date():
    ...
    chosen_date = "2024-7-24"  # NHL - 2021
...
def get_game_id():
    ...
    # game_id = 422  # BMBL - 2023
    game_id = 431  # BMBL - 2024
    # game_id = 458  # BMBL - 2025
...
def get_game_key():
    ...
    # game_key = "422" # BMBL 2023
    game_key = "431" # BMBL 2024
    # game_key = "458" # BMBL 2025
...
def get_league_id():
    ...
    # league_id = "33631"  # BMBL 2023
    league_id = "27471"  # BMBL 2024
...
def get_team_name():
    # FOOTBALL
    team_name = "Spokane Sasquatch"  # NFL
